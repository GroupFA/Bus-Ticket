...
<body>
            ...
            <div id="top-nav" class="hidden-xs">
                <div class="container">
                    <ul class="clearfix">
                        ...
                        <li class="pull-right diff"><a href="${pageContext.request.contextPath}/AccountServlet"><span class="hidden-xs">Đăng nhập</span></a></li>
                        <li class="pull-right"><a target="_blank" href="${pageContext.request.contextPath}/RegisterServlet"> Đăng ký </a> </li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="carousel">
            <div id="carousel-id" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="item">
                        <img class="images-carousel" src="images/6.jpg" alt="" srcset="" width="100%">
                    </div>
                    <div class="item">
                        <img class="images-carousel" src="images/1.jpg" alt="" srcset="" width="100%">
                    </div>
                    <div class="item active">
                        <img class="images-carousel" src="images/3.jpg" alt="" srcset="" width="100%">
                    </div>
                </div>
            </div>
            <!--đóng carousel  -->
        ...
        <div class="box-search">
            ...
            <form action="search" method="GET">
                ...
                <table width="100%" cellspacing="0" class="table-search">
                    <tbody>
                        <tr>
                            <td><input type="text" class="form-control" placeholder="Điểm đi" autocomplete="off"></td>
                            <td><input type="text" class="form-control" placeholder="Điểm đến" autocomplete="off"></td>
                            <td><input type="text" class="form-control" placeholder="Ngày xuất bến"></td>
                            <td><input type="text" class="form-control" placeholder="Giờ đi"></td>
    ...
    <section id="body-content">
        <div class="container">
            <div class="row">
                <h3 class="text-primary text-uppercase">Các tuyến đường phổ biến</h3>
                            ...
                            <tbody>
                                    ...
                                    <td>
                                        <p>
                                            <strong class="text-primary">
                                                240,000<sup>đ/vé</sup>
                                            </strong>
                                        </p>
                                    </td>
                                    <td>

                                        <a class="br-btn-flat br-watch-schedule"
                                            href="/vi-VN/tp-ho-chi-minh-di-da-lat-1375.html">
                                            <i class="fa fa-clock-o icon-flat text-success"></i>
                                        </a>
                                    </td>
                                    <td>

                                        <a href="/vi-VN/mua-ve-xe-tp-ho-chi-minh-di-da-lat.html"
                                ...
                                <tr class="route-row1378">
                                    ...
                                    <td>
                                        ...
                                        <a class="br-btn-flat br-watch-schedule"
                                            href="/vi-VN/tp-ho-chi-minh-di-buon-ma-thuot-1378.html">
                                            <i class="fa fa-clock-o icon-flat text-success"></i>
                                        </a>
                                    </td>
                                    <td>

                                        <a href="/vi-VN/mua-ve-xe-tp-ho-chi-minh-di-buon-ma-thuot.html"
                                ...
                                <tr class="route-row485">
                                    ...
                                    <td>
                                        ...
                                        <a class="br-btn-flat br-watch-schedule"
                                            href="/vi-VN/tp-ho-chi-minh-di-nha-trang-485.html">
                                            <i class="fa fa-clock-o icon-flat text-success"></i>
                                        </a>
                                    </td>
                                    <td>

                                        <a href="/vi-VN/mua-ve-xe-tp-ho-chi-minh-di-nha-trang.html"
                                ...
                                <tr class="route-row827">
                                    ...
                                    <td>
                                        ...
                                        <a class="br-btn-flat br-watch-schedule"
                                            href="/vi-VN/tp-ho-chi-minh-di-phan-thiet-827.html">
                                            <i class="fa fa-clock-o icon-flat text-success"></i>
                                        </a>
                                    </td>
                                    <td>

                                        <a href="/vi-VN/mua-ve-xe-tp-ho-chi-minh-di-phan-thiet.html"
