				...
				<div class="container">
					<ul class="clearfix">
						...
						<li class="pull-right diff"><a href="#"><span
								class="hidden-xs">Hi, Admin</span></a></li>
			...
			<table class="table-dsach">
				...
				<thead>
					<tr>
						...
						<th>Fullname</th>
						<th>gender</th>
						<th  class="wrapper" id="demo-1">address</th>
						<th>phoneNumber</th>
						<th>role</th>
						<th>Email</th>
						<th></th>
				...
				<tbody>
					<c:forEach var="user" items="${user}">
						<tr>
							...
							<td>${user.getRole()}</td>
							<td>${user.getEmail()}</td>
							<td><a href="${pageContext.request.contextPath}/DetailUserServlet?idUser=${user.getIdUser()}">Update</a></td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
