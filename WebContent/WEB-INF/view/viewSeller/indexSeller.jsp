      ...
      <div id="top-nav" class="hidden-xs">
        <div class="container">
          <ul class="clearfix">
            ...
            <li class="pull-right diff"><a href="#"><span class="hidden-xs"></span></a></li>
            <li class="pull-right"><a target="_blank" href="#"><i class="fa fa-facebook-square"></i>Chào Nhân viên</a>
            </li>
          </ul>
        </div>
      </div>
              ...
              <tr>
                <td>
                  <div class="shopee-searchbar">
                    <div class="shopee-searchbar__main">
                      <form role="search" class="form-control" autocomplete="off"><input aria-label="Tìm kiếm"
                          class="form-control" maxlength="128" placeholder="Tìm kiếm" autocomplete="off" value="">
                      </form>
                    </div>
                  </div>
                </td>
                <td>
                  <select class="form-control">
                    ...
                    <option value="0" label="Chổ ngồi đã đặt">Chổ ngồi đã đặt</option>
                    <option value="1" label="Tất cả chổ ngồi trống">Tất cả chổ ngồi trống</option>
                  </select>
                </td>
              </tr>
            </tbody>
