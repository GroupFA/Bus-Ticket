                        ...
                        <div class="row row-space">
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" name="usersName">
                                </div>
                            </div>
                        ...
                        <div class="row row-space">
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="password" name="repassword">
                                </div>
                            </div>
                        </div>
                        <div class="row row-space">
                        ...
                        <div class="row row-space">
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" name="phoneNum">
                                </div>
                            </div>
                        </div>
                        <div class="row row-space">
